...
class CustomUser(AbstractUser):
    ...
    documento = models.BigIntegerField(validators=[RegexValidator(regex='[0-9]{8}$', message='El documento introducido debe ser de 8 dígitos', code='nomatch')], unique=True, null=True)
    domicilio = models.CharField(max_length=100, null=True)
    telefono = models.BigIntegerField(validators=[RegexValidator(regex='[0-9]{2,4}-[0-9]{6}$', message='Introduzca un numero de teléfono válido, con la forma "+011-123456", o sea: "+", característica provincial, "-" (guión), y por último número de teléfono. En caso de ser celular, omita el "15".')], null=True)
